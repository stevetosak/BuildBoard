...
import ValidationErrorLayout, {
	type ValidationActionResult,
} from "@pages/shared/ValidationError.tsx";
...
const Register = () => {
	...
	return (
		<main
			className={
				"w-screen h-screen bg-bg-1 grid place-items-center text-lg group"
			}
		>
			<ValidationErrorLayout error={registerError}>
				...
				>
					...
					<Form
						className={"text-white grid gap-5 grid grid-cols-[1fr_1fr]"}
						method={"post"}
					>
						...
						<div className={"col-span-2 input-wrapper"}>
							...
							<select
								...
								id={"sex"}
								className={
									"user-info-input-hover border-1 border-white p-2 rounded w-full bg-bg-1"
								}
							>
								<option>Male</option>
