...
import { Replies } from "@/pages/TopicPage/ui/Replies";
import { useMemo, useState } from "react";
import { AnimatePresence, motion } from "framer-motion";
import { Textarea } from "@/components/ui/textarea.tsx";
import fetchMockReplies from "@/pages/TopicPage/data/fetchReplies";
...
const DiscussionThread = ({
    ...
    const mockReplies = useMemo(() => fetchMockReplies(data), [data])
